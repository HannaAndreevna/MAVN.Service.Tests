...
public enum CreatePaymentRequestStatus {
    ...
    private static Map<String, CreatePaymentRequestStatus> FORMAT_MAP =
            Stream.of(CreatePaymentRequestStatus.values())
                    .collect(toMap(c -> c.getCode(), Function.identity()));
    @Getter
    private String code;

    @JsonCreator
    public static CreatePaymentRequestStatus fromString(String value) {
        return Optional
