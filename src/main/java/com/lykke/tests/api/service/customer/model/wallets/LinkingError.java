...
public enum LinkingError {
    ...
    private static Map<String, com.lykke.tests.api.service.crosschainwalletlinker.model.LinkingError> FORMAT_MAP =
            Stream.of(com.lykke.tests.api.service.crosschainwalletlinker.model.LinkingError.values())
    ...
    @JsonCreator
    public static com.lykke.tests.api.service.crosschainwalletlinker.model.LinkingError fromString(String value) {
        return Optional
