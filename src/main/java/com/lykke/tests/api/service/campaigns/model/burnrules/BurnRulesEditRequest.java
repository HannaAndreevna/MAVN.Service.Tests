...
@Builder
@Data
public class BurnRulesEditRequest {

    private static final String LENGTH_OF_VALUE_MUST_BE_AT_LEAST_3_MESSAGE
            = "The length of 'Value' must be at least 3 characters. You entered %s characters.";
    private static final String LENGTH_OF_VALUE_MUST_BE_50_MESSAGE
            = "The length of 'Value' must be 50 characters or fewer. You entered %s characters.";
    ...
    private static final String LENGTH_OF_VALUE_MUST_BE_1000_MESSAGE
            = "The length of 'Value' must be 1000 characters or fewer. You entered %s characters.";
    ...
    private boolean isAmountInTokensValid() {
        return (amountInTokens > 0) && (amountInTokens < 2147483647);
    }

    private boolean isAmountInCurrencyValid() {
        return (amountInCurrency > 0) && (amountInTokens < 2147483647);
    }
