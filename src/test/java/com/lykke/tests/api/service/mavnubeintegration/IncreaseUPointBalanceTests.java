...
public class IncreaseUPointBalanceTests extends BaseApiTest {
    ...
    void shouldIncreaseUPointBalance() {
        IncreaseUPointsBalanceUtils.increaseUPointsBalance(CUSTOMER_ID, changeBalance)
                .then()
                .assertThat()
